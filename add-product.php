...
if (!isset($_SESSION["login"])) {
  echo "<script>
          alert('Harap masuk sebagai Admin!');
        ...
        <form action="" method="POST" enctype="multipart/form-data" autocomplete="off">
          <table>
            ...
            <tr>
              ...
              <td><input type="date" name="date" id="date" class="form-input" 
              value="<?= $mode == "edit" ? $product["date_released"] : date("Y-m-d"); ?>" readonly></td>
            </tr>
            ...
            <tr>
              ...
              value="<?= $mode == "edit" ? $product["name"] : ""; ?>"></td>
            </tr>
            ...
            <tr>
              ...
              <td> <input type="number" name="price" id="price" placeholder="Price (IDR)" 
              class="form-input" required min="0"
              value="<?= $mode == "edit" ? $product["price"] : ""; ?>"></td>
            </tr>
            ...
            <tr>
              ...
              <td> <input type="number" name="stock" id="stock" placeholder="Stock" 
              class="form-input" required min="0"
              value="<?= $mode == "edit" ? $product["stock"] : ""; ?>"></td>
            </tr>
            ...
            <tr>
              ...
              <td> <input type="number" name="internal" id="internal" placeholder="Internal (GB)" 
              class="form-input" required min="0"
              value="<?= $mode == "edit" ? $product["internal"] : ""; ?>"></td>
            </tr>
            ...
            <tr>
              ...
              <td> <input type="number" name="ram" id="ram" placeholder="RAM (GB)" 
              class="form-input" required min="0"
              value="<?= $mode == "edit" ? $product["ram"] : ""; ?>"></td>
            </tr>
            ...
            <tr>
              ...
              <td> <input type="number" name="battery" id="battery" placeholder="Battery (mAh)" 
              class="form-input" required min="0"
              value="<?= $mode == "edit" ? $product["battery"] : ""; ?>"></td>
            </tr>
